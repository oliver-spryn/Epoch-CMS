...
*/
	strstr(dirname(__FILE__), "\\") ? $configScript = str_replace("system\library", "", dirname(__FILE__)) . "data\config.php" : $configScript = str_replace("system/library", "", dirname(__FILE__)) . "data/config.php";
